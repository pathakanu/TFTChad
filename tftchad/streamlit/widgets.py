...
from tftchad.backend.constants import (
    CHUNK_OVERLAP_PCT,
    CHUNK_SIZE,
...
from tftchad.backend.models import MODELS
from tftchad.streamlit.constants import (
    ACTIVELOOP_HELP,
    APP_NAME,
    OPENAI_HELP,
    PAGE_ICON,
...
from tftchad.streamlit.helper import (
...
def page_header():
    ...
    st.set_page_config(
        page_title=APP_NAME,
        page_icon=PAGES_ICON,
        initial_sidebar_state="expanded",
        layout="centered",
    )
    st.markdown(
        f"<h1 style='text-align: center;'>{APP_NAME} {PAGE_ICON} <br> Ask all your Queries! </h1>",
    ...
    st.markdown(
         ...
         <style>
         .stApp {{
             background: url("https://startupxplore.com/uploads/ff80808168a73e330168a8b3c3f2005c-large.png");
             background-repeat: no-repeat;
            #  background-position: right 21% bottom 50%;
